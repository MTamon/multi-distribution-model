TRAIN_MANIFEST=/mnt/t4/nemo/ASJ_SNR00_10HA/manifest/train_nodup_sp/train_nodup_sp_manifest.json
VALID_MANIFEST=/mnt/t4/nemo/ASJ_SNR00_10HA/manifest/valid/valid_manifest.json
TESTS_MANIFEST=/mnt/t4/nemo/ASJ_SNR00_10HA/manifest/train_dev/train_dev_manifest.json
VOCAB_PATH=./asj_exp/pretrain/vocab_CTC.txt
NEMO_PATH=./models/confCTC_BEST.nemo
EXP_DIR=./asj_exp/snr00_10ha
NAME="snr00_10ha"

TRAIN_MANIFEST=/mnt/disks/disk-3/mikawa/asj/data/ASJ_SNR05_30HA/manifest/train_nodup_sp/train_nodup_sp_manifest.json
VALID_MANIFEST=/mnt/disks/disk-3/mikawa/asj/data/ASJ_SNR05_30HA/manifest/valid/valid_manifest.json
TESTS_MANIFEST=/mnt/disks/disk-3/mikawa/asj/data/ASJ_SNR05_30HA/manifest/train_dev/train_dev_manifest.json
VOCAB_PATH=./asj_exp/pretrain/vocab_CTC.txt
NEMO_PATH=./models/confCTC_BEST.nemo
EXP_DIR=./asj_exp/snr05_30ha
NAME="snr05_30ha"

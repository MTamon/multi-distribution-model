...
# from nemo.collections.asr.models import EncDecCTCModel # noqa pylint: disable=unused-import
# from overwrite_tools import FastEncDecCTCModel

# EncDecCTCModel = FastEncDecCTCModel
...
def main(cfg: EvaluationConfig):
    ...
    with open(transcription_cfg.output_filename, "r", encoding="utf-8") as f:
        for line in f:

...
def build_charset(data_path: str, train_dir_name: str, valid_dir_name: str, **_) -> Dict[str, Dict[str, int]]:
    ...
    direc = Directory(data_path)
    train_manifests = direc.get_file_path(filters=train_filter)
    valid_manifests = direc.get_file_path(filters=valid_filter)
